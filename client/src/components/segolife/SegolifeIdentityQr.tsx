 ...
 */
export function SegolifeIdentityQrContent({ autoLoad = true }: { autoLoad?: boolean }) {
 ...
 * del header (spec: "no competir visualmente", icono, no texto). Abre un
 * Dialog en vez de navegar: el Student llega a su QR sin perder dónde
 * estaba (Home, Explore, donde sea) — un toque para verlo, un toque para
 * cerrarlo.
 */
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-xs">
          <DialogHeader>
            <DialogTitle className="text-center">{t("profile.identityQrTitle")}</DialogTitle>
          </DialogHeader>
